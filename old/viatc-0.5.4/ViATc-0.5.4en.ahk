...
Setting()
{
	...
	Gui,Add,Tab2,x10 y6 +theme h320 w405 center choose2, Genereal (&U) | Hotkey (&P) | Path setting (&M)
	...
	Gui,Add,CheckBox,x25 y270 h20 checked%GroupWarn% vGroupWarn, Group Key tooltips (for: s g z c V) (&K)
